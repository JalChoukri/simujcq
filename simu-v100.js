...
function cacheElements() {
  ...
  // Cache hidden form fields for data capture
...
// Download results as JPEG using html2canvas
function downloadResults() {
  try {
    ...
    // Use html2canvas to capture the score breakdown area
    html2canvas(scoreBreakdownArea, options)
      .then((canvas) => {
